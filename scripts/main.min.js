...
!function(){"use strict";window.$=window.jQuery=require("../vendor/jquery-1.11.3.min.js"),require("../vendor/jquery.easing.min.js"),require("../vendor/jquery.fancybox.js");var e=(require("../vendor/bootstrap.min.js"),require("./gallery.js"));$(document).ready(function(){$("body").scrollspy({target:"#navbar"}),$(".fancybox").fancybox(),e($("#gallery")),$(function(){$("a.page-scroll").bind("click",function(e){var r=$(this);$("html, body").stop().animate({scrollTop:$(r.attr("href")).offset().top},1e3,"easeInOutExpo"),e.preventDefault()})}),$(".jumbo-presentation").height($(".jumbo-presentation").height())})}();
},{"../vendor/bootstrap.min.js":4,"../vendor/jquery-1.11.3.min.js":5,"../vendor/jquery.easing.min.js":6,"../vendor/jquery.fancybox.js":7,"./gallery.js":2}],2:[function(require,module,exports){
!function(){"use strict";var e=require("./util.js"),t=function(t){var a,i=t.find(".gallery__item"),l=function(){var e=$(window).width();a=3,e<768?a=1:e<992&&(a=2)};l(),window.addEventListener("resize",e.throttle(l,50,{leading:!0}));var r=function(e){var t=e.index();e.addClass("gallery__item--open");var l=(t+1)%a,r=0;l>0&&(r=a-l);var n=t+r;n>=i.length&&(n=i.length-1);var s=$(i[n]),o=e.find(".gallery__sub-gallery").clone(),d="left";2===l||1===a?d="center":0===l&&(d="right");var u="arrow-pos-"+d,g=$('<div class="gallery__sub-gallery-display col-sm-12"></div>');g.append($('<div class="arrow-container '+u+'"></div>')),g.append(o),setTimeout(function(){g.height(o.outerHeight()+20),g.addClass("open")},1),s.after(g)};i.click(function(){var e=$(this),t=$(".gallery__sub-gallery-display");t.length>0?(t.removeClass("open"),t.height(0),setTimeout(function(){t.remove()},600),e.hasClass("gallery__item--open")||setTimeout(function(){r(e)},600),i.removeClass("gallery__item--open")):r(e)})};module.exports=t}();

},{"./util.js":3}],3:[function(require,module,exports){
!function(){"use strict";$=require("../vendor/jquery-1.11.3.min.js");var n={throttle:function(n,t){var u=null;return function(){var r=this,e=arguments;null===u&&(u=setTimeout(function(){n.apply(r,e),u=null},t))}}};module.exports=n}();

},{"../vendor/jquery-1.11.3.min.js":5}],4:[function(require,module,exports){
